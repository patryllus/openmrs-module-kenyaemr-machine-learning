 ...
 */
@Controller("kenyaemrml.MLinKenyaEMRController")
@RequestMapping(value = "module/kenyaemrml/kenyaemrml.form")
public class MLinKenyaEMRController {
	...
	private final String VIEW = "/module/kenyaemrml/kenyaemrml";
